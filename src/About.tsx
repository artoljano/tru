...
function About() {
  ...
  const platforms = [
    { icon: CustomIcon, name: "Spotify", color: "hover:text-green-500" },
              ...
              >
                ...
                <div className="space-y-4 text-gray-300">
                  <p>
                    ...
                    curiosity to every conversation. His journey began with a
                    successful YouTube channel where he discovered the power of
                    meaningful dialogue.
                  </p>
                  <p>
                    A graduate in Digital Communications and former content
                    creator, John has always been fascinated by the intersection
                    of technology, culture, and human experience. His natural
                    ability to connect with people and draw out their stories
                    has quickly made this podcast a rising star in the industry.
                  </p>
                  <p>
                    "I started this podcast because I believe everyone has a
                    story worth sharing. My goal is to create a space where
                    authentic conversations can flourish and where both our
                    guests and listeners can discover new perspectives."
                  </p>
                </div>
