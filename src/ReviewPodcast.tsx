...
const episodes = [
  { id: 1, title: "The Future of AI in Healthcare", guest: "Dr. Sarah Johnson" },
    ...
    <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 text-white pt-24">
      <div className="container mx-auto px-4 max-w-4xl">
        <div className="text-center mb-12">
          <h1 className="text-4xl md:text-6xl font-bold mb-6">Share Your Thoughts</h1>
          <p className="text-xl md:text-2xl text-gray-300 max-w-2xl mx-auto">
            Your feedback helps us improve and create better content for our community.
          </p>
        </div>
        ...
        <div className="bg-gray-900/50 rounded-xl p-8 backdrop-blur-sm shadow-xl">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <div className="space-y-2">
              <label htmlFor="episodeId" className="block text-sm font-medium text-gray-300">Select Episode</label>
              <select
                id="episodeId"
                name="episodeId"
            ...
            <div className="space-y-2">
              <label htmlFor="review" className="block text-sm font-medium text-gray-300">Your Review</label>
              <textarea
                id="review"
                name="review"
            ...
            <button
              type="submit"
              className="w-full bg-gradient-to-r from-purple-600 to-blue-600 text-white py-4 rounded-lg font-semibold hover:from-purple-700 hover:to-blue-700 transition-all duration-300 flex items-center justify-center space-x-2"
            >
